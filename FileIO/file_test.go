...
func TestThat_File_Returns_FileIfc(t *testing.T) {
	// Test
	var sut FileIfc = File(MISSING_FILE)
...
func TestThat_File_GetAbsPath_Returns_GoodPath(t *testing.T) {
	...
	sut := File(filepath.Join(".", MISSING_FILE))
...
func TestThat_File_Exists_Returns_True_ForGoodFile(t *testing.T) {
	// Setup
	sut := File(filepath.Join(TEST_RESOURCE_DIR, TEST_FILE))
