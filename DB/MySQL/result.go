...
type ResultIfc interface {
	...
	GetPropertyPointers() (*[]interface{}, err)
}
...
func (r *Result) GetPropertyPointers() (*[]interface{}, err) {
	...
	r.propertyPointers := make([]interface{}, numFields)
...
func (r *Result) newValue(datatype string) (interface{}, err) {
	switch datatype {
		case "*string":
			nv := ""
			return &nv, nil
